...
export type Level = {
    ...
    description: string;
    hint: string;
    expectedQuery?: string; // Optional: The correct SQL query for this level
...
export const LEVELS: Level[] = [
    ...
    },
    {
        ...
        expectedQuery: "SELECT timestamp FROM system_metrics WHERE metric_name = 'Gravity' AND value < 0.5",
        targetResult: {
            columns: ["timestamp"],
            rows: [["2023-10-24 23:30:00"], ["2023-10-24 23:45:00"]],
        },
    },
    {
        id: 3,
        ...
        expectedQuery: "SELECT location FROM sensor_logs WHERE sensor_type = 'Radiation' ORDER BY reading DESC LIMIT 1",
        targetResult: {
            columns: ["location"],
            rows: [["Cargo Bay"]],
        },
    },
    {
        ...
        expectedQuery: "SELECT e.name FROM employees e JOIN building_access_logs b ON e.id = b.employee_id WHERE b.room_name = 'Airlock_4'",
        targetResult: {
            columns: ["name"],
            rows: [["Greg Sales"]],
        },
    },
    {
        ...
        expectedQuery: "SELECT department_id, COUNT(*) as count FROM employees GROUP BY department_id",
        targetResult: {
    ...
    },
    {
        ...
        expectedQuery: "SELECT pid FROM active_processes WHERE name = 'protocol_antigravity'",
        targetResult: {
            columns: ["pid"],
            rows: [[404]],
        },
